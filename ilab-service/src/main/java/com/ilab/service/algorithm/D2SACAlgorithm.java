...
public class D2SACAlgorithm {
    ...
    private static Integer getD2SACAction(List<Double> state) {
        String u = "http://192.168.103.66:5000/getD2SACAction";
